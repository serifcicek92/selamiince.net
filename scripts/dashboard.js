(function($) {
  ...
  $(function() {
    if ($("#performaneLine").length) {
      console.log("PWERASFKJOISDAJFLASKJFA");
      console.log($("#performaneLine").data('pzt'));
      ...
      var salesTopData = {
          ...
          datasets: [{
              label: 'Bu Hafta',
              data: [$("#performaneLine").data('pzt'),
                    $("#performaneLine").data('sal'), 
                    $("#performaneLine").data('car'),
                    $("#performaneLine").data('per'), 
                    $("#performaneLine").data('cum'), 
                    $("#performaneLine").data('cts'), 
                    $("#performaneLine").data('paz')],
            ...
            label: 'Geçen Hafta',
            data: [$("#performaneLine").data('gpzt'),
            $("#performaneLine").data('gsal'), 
            $("#performaneLine").data('gcar'),
            $("#performaneLine").data('gper'), 
            $("#performaneLine").data('gcum'), 
            $("#performaneLine").data('gcts'), 
            $("#performaneLine").data('gpaz')],
